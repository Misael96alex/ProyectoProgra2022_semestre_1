<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="menuMedicamentos.aspx.cs" Inherits="ConsumeServicio.PaginasMedicamentos.menuMedicamentos" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <LINK REL=StyleSheet HREF="menuMedicamentos.css" TYPE="text/css"/>
    <title>Menu Medicamentos</title>
</head>
<body>
    <form id="form1" runat="server">
        ...
        <div>
            <div class ="titulo"><center><asp:Label ID="Label1" runat="server" Text="Menú Medicamentos"></asp:Label></center><br /></div>
