<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="borrarUsuario.aspx.cs" Inherits="ConsumeServicio.PaginasUsuario.borrarUsuario" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <LINK REL=StyleSheet HREF="borrarUsuario.css" TYPE="text/css"/>
...
<body>
    <form id="form1" runat="server">
        ...
        <div>
			<div class ="titulo"><center><asp:Label ID="Label1" runat="server" Text="Borrar Usuarios"></asp:Label></center>
            </div>
			<center>
			<div class="agregar">
