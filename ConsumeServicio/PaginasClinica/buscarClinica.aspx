<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="buscarClinica.aspx.cs" Inherits="ConsumeServicio.PaginasClinica.buscarClinica" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <LINK REL=StyleSheet HREF="buscarClinica.css" TYPE="text/css"/>
    <title>Buscar Clinica</title>
</head>
<body>
    <form id="form1" runat="server">
        ...
        <div>
			<div class ="titulo"><center><asp:Label ID="Label1" runat="server" Text="Buscar Clinicas"></asp:Label></center>
            </div>
			<center>
			<div class="agregar">
