<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="menuPaciente.aspx.cs" Inherits="ConsumeServicio.PaginasPacientes.menuPaciente" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <LINK REL=StyleSheet HREF="menuPaciente.css" TYPE="text/css"/>
...
<body>
    <form id="form1" runat="server">
        ...
        <div>
            <div class ="titulo"><center><asp:Label ID="Label1" runat="server" Text="Menú Paciente"></asp:Label></center><br /></div>
