<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="menuEnfermedades.aspx.cs" Inherits="ConsumeServicio.PaginasEnfermedades.menuEnfermedades" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <LINK REL=StyleSheet HREF="menuEnfermedades.css" TYPE="text/css"/>
    <title>Menu Enfermedades</title>
</head>
<body>
    <form id="form1" runat="server">
        ...
        <div>
            <div class ="titulo"><center><asp:Label ID="Label1" runat="server" Text="Menú Enfermedades"></asp:Label></center><br /></div>
